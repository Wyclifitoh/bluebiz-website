              ...
              <div key={item.name} className="relative group">
                {item.dropdown ? (
                  ...
                  >
                    ...
                    {/* Dropdown Menu */}
                    <div
                      className={`absolute top-full left-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-light-grey/50 py-2 transition-all duration-200 ${
                        isResourcesOpen
            ...
            <div className="space-y-3">
              {navigation.map((item) => (
                <div key={item.name}>
                  {item.dropdown ? (
                    <div>
                      <div className="text-sm font-medium text-dark-grey/70 mb-2">
                        {item.name}
                      </div>
                      {item.dropdown.map((subItem) => (
                        <Link
