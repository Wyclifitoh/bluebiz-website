...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.bluebizkenya.com/contact", {
        method: "POST",
        headers: {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
              Get in touch with BlueBiz Kenya. We're here to support your
              entrepreneurial journey across Kenya's coastal region.
            </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-primary-orange/20 mb-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-dark-grey/70 text-sm mb-3">
                        TechnoServe Mombasa - Fidel Odinga Road | Texas Building
                        4th Floor Nyali
                      </p> 
                    </div>
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {submitStatus.message && (
            <div
              className={`mb-8 p-6 rounded-2xl flex items-center border ${
          ...
          <form
            ...
            className="bg-white rounded-2xl p-8 space-y-6 border border-light-grey/50 shadow-xl"
          >
