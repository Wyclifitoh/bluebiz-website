  ...
  const investorTypes = [
    {
      ...
      description: "Connect with individual investors and VC firms who specialize in early-stage businesses and have experience in the coastal and blue economy sectors.",
      features: [
    ...
    },
    {
      ...
      description: "Access smaller loans from microfinance institutions and community-based financial organizations that understand local business needs.",
      features: [
    ...
    },
    {
      ...
      description: "Take advantage of government initiatives, grants, and programs specifically designed to support youth entrepreneurship and coastal development.",
      features: [
    ...
    },
    {
      ...
      description: "Leverage online platforms to raise funds from multiple small investors who believe in your business concept and social impact.",
      features: [
  ...
  const fundingProcess = [
    {
      ...
      description: "We evaluate your business plan, financial projections, and funding needs to determine the best financing options.",
      icon: <Target className="h-6 w-6" />
    },
    {
      step: 2,
      title: "Investor Matching",
      description: "Connect with pre-vetted investors and lenders who align with your business sector and funding requirements.",
      icon: <Users className="h-6 w-6" />
    },
    {
      step: 3,
      title: "Pitch Preparation",
      description: "Receive coaching and support to create compelling pitch presentations and business proposals.",
      icon: <Sparkles className="h-6 w-6" />
    },
    {
      step: 4,
      title: "Application Support",
      description: "Get assistance with loan applications, grant proposals, and investor presentations.",
      icon: <Shield className="h-6 w-6" />
    },
    {
      step: 5,
      title: "Funding Success",
      description: "Secure funding and receive ongoing support to ensure successful utilization of the capital.",
    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/3 right-1/3 w-24 h-24 bg-program-green/20 rounded-full blur-xl animate-float" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto"> 
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
              Unlock funding opportunities tailored for coastal businesses and the blue economy. Connect with investors, lenders, and grant providers who understand your market.
            </p>
...
{/* 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-dark-grey mb-4">Why Choose BlueBiz for Funding?</h2>
          </div>
            ...
            {[
              {
                ...
                description: "Access to pre-vetted, reputable investors and lenders with proven track records.",
                color: "from-teal to-program-green"
              },
              {
                icon: <Users className="h-8 w-8" />,
                title: "Expert Guidance",
                description: "Receive personalized support from experienced mentors throughout the funding process.",
                color: "from-primary-orange to-secondary-gold"
              },
              {
                icon: <Clock className="h-8 w-8" />,
                title: "Faster Process",
                description: "Streamlined application processes and faster decision times through our network.",
                color: "from-accent to-yellow"
              }
            ].map((benefit, index) => (
              <div key={index} className="text-center group">
                ...
                <h3 className="text-xl font-bold text-dark-grey mb-3 group-hover:text-primary-orange transition-colors">{benefit.title}</h3>
                <p className="text-dark-grey/70 leading-relaxed">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-orange via-secondary-gold to-yellow text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Secure Funding?</h2>
          <p className="text-xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join BlueBiz Kenya and get connected with the right funding sources for your business. Our expert team will guide you through every step of the process.
          </p>
